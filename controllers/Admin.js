...
module.exports = BaseController.extend({
	...
	list: function(callback) {
		model.getlist(function(err, records) {
			...
			markup += '\
				<tr class="categories">\
					<td class="categorie__item"><strong>type</strong></td>\
					<td class="categorie__item"><strong>title</strong></td>\
					<td class="categorie__item"><strong>picture</strong></td>\
					<td class="categorie__item"><strong>actions</strong></td>\
				</tr>\
			';
